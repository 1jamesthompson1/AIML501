...
Gaps are
How to define the correct sort of alignment target
How do we collect data that represents the alignment target
How do we use this data to align a large language model
How do we evaluate the success of this alignment to the target
