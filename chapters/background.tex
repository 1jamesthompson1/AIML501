...
The status quo of the world is here. If we are going to add a new technology to society it should be to improve the society by some metric (what metric).

The metric that makes sense is some form of human flourishing (idea from https://survivalandflourishing.fund/). 

Currently AI is being made for profit maximization of companies. It is a misalignemtn fo goals ...
...
Who is AI even for. Is it for current people, future people etc. It should be for everyone. Ideas of non exclusion, as well as non domination.

Currently there is concerns for the "users" of AI being companies and so the benefits of the AI being towards those companies and a select few.

\subsection{Alignment of AI}

Given that everyone is the stakeholder of AI we should align collectively too all of them.

Full stack alignment is in the institutions and systems surrounding AI as well.

As showed above the goal of AI and the stakeholders of AI are meaning taht AI is not aligned to thebest interests of "human flourishing".
...
We want Ai to be built in a fully aligned system. In a world where the institutions and systems around AI are aligned to human values and goals.

Currently we don't have that as the institutions and systems around AI are not aligned to human values and goals.

A better way forward is that of AI that is funded by, owned by, and operated by the public for the public good. This is the idea of PublicAI \cite{publicai2024}...
