...
\textit{A basic introduction to large language models that are transformer based. Including simple description of self attention, along with training process of pretraining and next token prediction.}
