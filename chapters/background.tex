...
\todo{A bit rushed here as ran out of time}

Given the stakes are very high there should be significant effort into ensuring that these risks are mitigated and negative events avoided. One can think about AI safety and ways of preventing catastrophic risks as gas pedal (constructive) and brake (restrictive) actions.
