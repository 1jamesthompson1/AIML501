...
Choosing a single set of values for alignment is also problematic as it could prevent the natural evolution of human values over time. We can observe that human societies have progressed over time towards being more \scare{morally good} (freer, fairer, healthier, wealthier, kinder) \cite{pinkerBetterAngelsOur2012,berlinCrookedTimberHumanity2012,singerExpandingCircleEthics1981}. The progress of human values can be thought of as balancing different valid values better and identifying new valid values that were previously ignored \cite{rossRightGood2002}.
